...
public class PiecePositionAnalyzer {
    ...
    private final static int[] blackPawnPositions = {
            0, 0, 0, 0, 0, 0, 0, 0,
            5, 10, 10, -20, -20, 10, 10, 5,
            5, -5, -10, 0, 0, -10, -5, 5,
            0, 0, 0, 20, 20, 0, 0, 0,
    ...
    private final static int[] queenPositions = {
    ...
    private final static int[] knightPositions = {
    ...
    private final static int[] whiteRookPositions = {
            0, 0, 0, 0, 0, 0, 0, 0,
    ...
    private final static int[] blackRookPositions = {
            0, 0, 0, 5, 5, 0, 0, 0,
            -5, 0, 0, 0, 0, 0, 0, -5,
            -5, 0, 0, 0, 0, 0, 0, -5,
            -5, 0, 0, 0, 0, 0, 0, -5,
    ...
    private final static int[] whiteKingPositions = {
    ...
    private final static int[] blackKingPositions = {
            20, 30, 10, 0, 0, 10, 30, 20,
            20, 20, 0, 0, 0, 0, 20, 20,
            -10, -20, -20, -20, -20, -20, -20, -10,
            -20, -30, -30, -40, -40, -30, -30, -20,
    ...
    private final static int[] whiteBishopPositions = {
    ...
    private final static int[] blackBishopPositions = {
            -20, -10, -10, -10, -10, -10, -10, -20,
            -10, 5, 0, 0, 0, 0, 5, -10,
            -10, 10, 10, 10, 10, 10, 10, -10,
            -10, 0, 10, 10, 10, 10, 0, -10,
